resource "aws_cognito_user_pool" "app_pool_v3" {
  name = "${local.name_prefix}-user-pool-v3"
...
resource "aws_cognito_identity_pool" "main" {
  ...
  cognito_identity_providers {
    ...
    provider_name           = aws_cognito_user_pool.app_pool_v3.endpoint
...
resource "aws_cognito_identity_pool_roles_attachment" "main" {
  ...
  role_mapping {
    identity_provider         = "${aws_cognito_user_pool.app_pool_v3.endpoint}:${aws_cognito_user_pool_client.app_client.id}"
