# SafeMate v2 Hedera Service V48.0 Deployment Script
# Deploys the updated Lambda function with NON_FUNGIBLE_UNIQUE folder tokens
...
Write-Host "🚀 SafeMate v2 Hedera Service V48.0 Deployment Script" -ForegroundColor Green
...
$zipFile = "hedera-service-v48.0.zip"
...
Write-Host ""
Write-Host "✨ SafeMate v2 Hedera Service V48.0 deployment complete! 🚀" -ForegroundColor Green
